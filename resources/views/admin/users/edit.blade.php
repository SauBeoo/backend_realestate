                    ...
                    <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="country" id="country" class="form-control @error('country') is-invalid @enderror" 
                                   value="{{ old('country', $user->country ?? 'Vietnam') }}">
                            @error('country')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div id="agent-fields" style="display: {{ old('user_type', $user->user_type) === 'agent' ? 'block' : 'none' }};">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="receive_marketing" id="receive_marketing" value="1" 
                                       {{ old('receive_marketing', $user->receive_marketing) ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    <div class="text-center mb-3">
                        <div class="bg-primary rounded-circle d-inline-flex align-items-center justify-content-center" style="width: 80px; height: 80px;">
                            <span class="text-white font-weight-bold h4">{{ $user->initials }}</span>
                        </div>
                        <h5 class="mt-2">{{ $user->full_name }}</h5>
                        <p class="text-muted">{{ ucfirst($user->user_type ?? 'buyer') }}</p>
                    </div>
                    ...
                    <div class="small">
                        ...
                        <p><strong>Properties:</strong> {{ $user->properties->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="small text-muted">
                        <p><strong>Password:</strong> Leave password fields blank to keep the current password.</p>
                        <p><strong>Agent Fields:</strong> License number, agency name, and commission rate are only relevant for agents.</p>
                        <p><strong>Status:</strong> Suspended users cannot access the system.</p>
                    </div>
                </div>
            </div>
        </div>
